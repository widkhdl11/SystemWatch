...
ii  cloud-init                     22.2-0ubuntu1~20.04.3               all          initialization and customization tool for cloud instances
...
ii  curl                           7.68.0-1ubuntu2.12                  amd64        command line tool for transferring data with URL syntax
ii  dash                           0.5.10.2-6                          amd64        POSIX-compliant shell
ii  dbus                           1.12.16-2ubuntu2.2                  amd64        simple interprocess messaging system (daemon and utilities)
ii  dbus-user-session              1.12.16-2ubuntu2.2                  amd64        simple interprocess messaging system (systemd --user integration)
ii  dbus-x11                       1.12.16-2ubuntu2.2                  amd64        simple interprocess messaging system (X11 deps)
...
ii  distro-info-data               0.43ubuntu1.10                      all          information about the distributions' releases (data files)
...
ii  git                            1:2.25.1-1ubuntu3.5                 amd64        fast, scalable, distributed revision control system
ii  git-man                        1:2.25.1-1ubuntu3.5                 all          fast, scalable, distributed revision control system (manual pages)
...
ii  libdbus-1-3:amd64              1.12.16-2ubuntu2.2                  amd64        simple interprocess messaging system (library)
...
ii  libgnutls-openssl27:amd64      3.6.13-2ubuntu1.12                  amd64        GNU TLS library - OpenSSL wrapper
...
ii  libnss-systemd:amd64           245.4-4ubuntu3.17                   amd64        nss module providing dynamic user and group name resolution
...
ii  libpam-systemd:amd64           245.4-4ubuntu3.17                   amd64        system and service manager - PAM module
...
ii  libsqlite3-0:amd64             3.31.1-4ubuntu0.7                   amd64        SQLite 3 shared library
...
ii  libsystemd0:amd64              245.4-4ubuntu3.17                   amd64        systemd utility library
...
ii  libudev1:amd64                 245.4-4ubuntu3.17                   amd64        libudev shared library
...
ii  linux-libc-dev:amd64           5.4.0-144.161                       amd64        Linux Kernel Headers for development
...
ii  motd-news-config               11ubuntu5.6                         all          Configuration for motd-news shipped in base-files
...
ii  snapd                          2.55.5+20.04                        amd64        Daemon and tooling that enable snap packages
ii  software-properties-common     0.99.9.8                            all          manage the repositories that you install software from (common)
ii  sosreport                      4.3-1ubuntu0.20.04.1                amd64        Set of tools to gather troubleshooting data from a system
ii  sound-theme-freedesktop        0.8-2ubuntu1                        all          freedesktop.org sound theme
ii  sqlite3                        3.31.1-4ubuntu0.7                   amd64        Command line interface for SQLite 3
...
ii  ssmtp                          2.64-8.1ubuntu1                     amd64        extremely simple MTA to get mail off the system to a mail hub
...
ii  systemd                        245.4-4ubuntu3.17                   amd64        system and service manager
ii  systemd-sysv                   245.4-4ubuntu3.17                   amd64        system and service manager - SysV links
ii  systemd-timesyncd              245.4-4ubuntu3.17                   amd64        minimalistic service to synchronize local time with NTP servers
...
ii  tmux                           3.0a-2ubuntu0.3                     amd64        terminal multiplexer
ii  tpm-udev                       0.4                                 all          udev rules for TPM modules
ii  tzdata                         2022a-0ubuntu0.20.04                all          time zone and daylight-saving time data
ii  ubuntu-advantage-tools         27.10.1~20.04.1                     amd64        management tools for Ubuntu Advantage
...
ii  udev                           245.4-4ubuntu3.17                   amd64        /dev/ and hotplug management daemon
...
ii  vim-runtime                    2:8.1.2269-1ubuntu5.7               all          Vi IMproved - Runtime files
